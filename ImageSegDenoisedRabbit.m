...
FolderDir ='E:\2020.05.28\omisore-02\Data-16.15-Push';
...
LagLead=1; incr = 50; %While incr of 11 is 1 Sec Image Data Frames, LagLead can be optimized using rawViewer.exe
...
% hWaitBar = waitbar(0, 'Reading the CT Images');
    ...
    for f = LagLead : incr : img_NUM-LagLead
        ...
        figure(102); clf; imshow(dsFrame,[]); title('Guidewire Navigation Frames');
        ...
        figure(104);clf; imagesc(FrameVesselness);  title('Vesselness Measure Result'); 
...
%             figure(106);clf; imshow(connectGuideWire);
        ...
        figure(106); imshow(DenoiseVessel); title('Guidewire Tracking');
...
%         cannImageLines = edge(connectGuideWire,'canny');
%         %figure(108);clf; imshow(cannImageLines);    title('Canny ImageLines in Image');
...
msgbox('Operation Completed','Success', 'modal');%,'custom',icondata,summer);